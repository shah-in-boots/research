...
This serves as a summary of current research progress, updates, and projects (clinical, translational, and programming). The most recent update to this page was as of `r format(Sys.Date(), "%A, %B %d, %Y")`. Please see here for weekly [updates](https://asshah4.github.io/research/R/t32-updates.html).

The major research focuses are currently on:

1. __Stress and Clinical Neurocardiology__: Physiological and psychological stress and cardiovascular mortality, from a neurocardiac perspective.
...
# Stress and Clinical Neurocardiology
...
Currently a work in progress as building a repertoire of pre-clinical literature.

## Atrial Fibrillation Registry

A catheter-ablation registry is being developed. The current status of the data acquisition process can be seen [here](https://asshah4.github.io/afib). No clinical data is available externally. 
