...
1. Weekly [T32/F32 research-in-progress](https://shah-in-boots.github.io/research/t32/rip.html) updates along with [T32/F32 mentorship meetings](https://shah-in-boots.github.io/research/t32/mentors.html) agends
1. Weekly [K23 research-in-progress](https://shah-in-boots.github.io/research/k23/rip.html) updates along with [K23 mentorship meetings](https://shah-in-boots.github.io/research/k23/mentors.html) agends
...
| AFL and Family History | Statistical analysis of relationship between early onset AFL and family history, which notably yields different phenotypes in Whites and Blacks. [WIP](https://shah-in-boots.github.io/aflubber) | 2022 |
...
| Vagolysis and Arrhythmogenesis | Measurement of vagolysis in arrhythmogenesis in the electrophysiology lab and using clinical and epidemiological data. Currently working on the development/progress [towards a K23 award](https://shah-in-boots.github.io/research/k23/planning.html), including pilot data collection. | 2022-now |
...
- Family history and genetic basis of [atrial flutter](https://shah-in-boots.github.io/aflubber)
...
- Murine models of vagolysis leading to triggered arrhythmias, which was initially proposed as an [AHA IPA](https://shah-in-boots.github.io/research/grants/aha_innovative_project_2022.html), but then withdrawn

## Computational Neurocardiology and Biostatistics

_Programming-based approaches in signal processing and biostatistics_

- Measuring circadian patterns and disturbances using a [cosinor regression method](https://shah-in-boots.github.io/card)
