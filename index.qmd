...
1. Weekly [T32/F32 research-in-progress](https://asshah4.github.io/research/t32/rip.html) updates along with [T32/F32 mentorship meetings](https://asshah4.github.io/research/t32/mentors.html) agends
1. Weekly [K23 research-in-progress](https://asshah4.github.io/research/k23/rip.html) updates along with [K23 mentorship meetings](https://asshah4.github.io/research/k23/mentors.html) agends
...
gantt
	...
	section ECG/TTN 
		...
		TTN variant selection						:active, vus, 10/2023, 180d
		Initial ML model training 			:done, ttn1, 11/2023, 60d
		Model revisions									:active, ttn2, 12/2023, 90d
		Model explainability 						:ttn3, 01/2023, 120d
		Manuscript drafting							:after ttn2, 90d
		Manuscript draft								:milestone, ttn4, after ttn3, 7d 
	section AFEQT/SDOH
		Complete AFEQT scoring					:done, scores, 10/2023, 60d
		Compile dataset from CCTS				:active, afeqt1, 11/2023, 30d
		Create matching data from JBVA	:after afeqt1, afeqt2, 30d
		Initial results									:milestone, afeqt1, 01/15/23, 7d
		Co-author feedback 							:after afeqt2, 14d
		Manuscript											:milestone, afeqt3, 02/2023, 7d
	section Phenotype 
		CCTS/CBCD IRB										:done, 04/2023, 30d
		Import CCTS data								:done, 05/2023, 60d
		Cluster hosting of data					:done, 06/2023, 60d
		Cleaning CCTS data							:active, ccts, 09/2023, 90d
	section AF/PRS
	section MSNA/ECG
	section CARRS/GEH
```
