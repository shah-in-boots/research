...
- The most recent update to this page was as of `r format(Sys.Date(), "%A, %B %d, %Y")` 
- Please see here for weekly [research-in-progress updates](https://asshah4.github.io/research/t32/rip.html)
- [Mentored meeting outlines](https://asshah4.github.io/research/t32/mentors.html) are available to document strategy and obstacles on a weekly and biweekly basis
- Current active goal is to move [towards a K08/K23 award](https://asshah4.github.io/research/k32/approach.html)
...
<<<<<<< HEAD
| Vagolysis and Arrhythmogenesis | Measurement of vagolysis in arrhythmogenesis in the electrophysiology lab and using clinical and epidemiological data. Currently working on the development/progress [towards a K08/K23 award](https://asshah4.github.io/research/k32/aims.html), including pilot data collection. | 2022-now |
=======
| Vagolysis and Arrhythmogenesis | Measurement of vagolysis in arrhythmogenesis in the electrophysiology lab and using clinical and epidemiological data. Currently working on the development/progress [towards a K08/K23 award](https://asshah4.github.io/research/k23/planning.html), including pilot data collection. | 2022-now |
>>>>>>> 4d7889a200edb1c526375dad92f463ef90354efe
