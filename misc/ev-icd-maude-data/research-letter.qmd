---
title: Real-World Safety Profile of the Extravascular (EV) Implantable Defibrillator System
...
800 words (excluded references and the figure legend text)
...
The recently published long-term outcomes of the Extravascular Implantable Cardioverter-Defibrillator (EV ICD) Pivotal Study shows promising results.
Friedman et al.[@Friedman2024] found that the EV ICD system provided 100% termination of discrete spontaneous ventricular arrhythmias, with no major intraprocedural or ICD complications from implant to final follow-up, and an overall freedom of related complications of 89% at 3 years.
...
We analyzed the post-market surveillance data from the U.S. Food & Drug Administration (**FDA**) publically-available Manufacturer and User Facility Device Experience (**MAUDE**) Database, which provides de-identified voluntary reporting for medical devices from health care professionals and mandatory reporting from manufacturers. 
Given these characteristics, this study did not rise to the level of “human subjects research” per Federal Common Rule (45 CFR Part 46) and per University of Utah policies did not require Institutional Review Board review.
...
In one report, defibrillatory testing failed to cardiovert ventricular fibrillation, leading to the addition of a transvenous system.
The relative frequency of these events are seen in @fig-events.

The total number of implants during the study time period is not able to be disclosed by the EV ICD manufacturer.
Although we cannot compare directly the rate of adverse events seen in the *Pivotal* trial, or the limited post-market surveillance *Enlighten* registry [@Crozier2025], we can identify the ratio of the most frequent complications and novel issues that have not yet been reported.
...
The MAUDE data lacks the total implant denominator to understand incidence.

Our findings highlight the importance of post-market surveillance and the number of events suggest the need to continue to closely monitor not only the long-term follow-up of clinical trial implants, but novel implants not included in other post-market registries [@Crozier2025].
As with many newer technologies, we anticipate that complication rates will improve with growing user experience and training but, although some complications may persist at higher rates due to the complexity of this technology and its implantation.
We believe this data should inform shared decision-making, informed consent, and discussion between physicians and patients as the EV ICD disseminates into broader clinical use.
...
Anish S. Shah: None  
Marc Engels: None  
Roger A. Freedman: Consultant for Abbott, Cook Medical, and Merit Medical.  
Immo Lehmann: None  
Klitos Konstantinidis: None  
Ravi Ranjan, MD, PhD: Consultant to Abbott and is also supported by NIH R01 HL 162353.  
T. Jared Bunch, MD:  None  

## Short-Form Description (*Tweet*)

Post-market surveillance for the EV ICD system, collected from the MAUDE database, shows a number of complications not previously seen.
