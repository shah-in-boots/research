...
products <-
	drive_get("research_log") |>
	read_sheet(sheet = "product_sheet") |>
	filter(Deadline >= date_build(year = 2020, month = 07, day = 01)) 
...
- Pedigrees and Manuscript

## ECG/EGM analysis

- Ability to detect peaks and intervals from raw multi-channel ECGs
