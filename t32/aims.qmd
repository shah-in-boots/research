...
1. __To evaluate the effect of modifying the intrinsic cardiac nervous system in the ablative treatment of vagally-mediated paroxysmal AF.__
_The burden and phenotype of AF will correlate with the expression of differential structural and autonomic biomarkers._
	a. [Baseline levels of autonomic hormones (NE, NPY, Gal)]{.orange} will correlate with the burden and chronicity of AF as a result of both electrical and mechanical remodeling. [Modification of the ICSN]{.red} through ablation during PVI, documented by the release of S100B,[@Mehra2022] will lead to will lead to &darr;NE, &darr;NPY, &darr;Gal expression (as a marker of decreased vagal afferent activity).
