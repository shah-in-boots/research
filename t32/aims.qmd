...
_The burden and phenotype of AF will correlate with the expression of differential structural and autonomic biomarkers._
	a. [Baseline levels of autonomic hormones (NE, NPY, galanin) and structural hormones (ANP, BNP, S100B)]{.orange} will correlate with the burden and chronicity of AF as a result of both electrical and mechanical remodeling.
	a. Increased adrenergic/physiological stress [through catecholamine infusion]{.red} (and/or mental stress) will lead to &darr;NE, &darr;NPY, &darr;Gal expression.
	a. Decrease vagal afferent activity [through modification of ICNS]{.red} with GP ablation during PVI, documented by release of S100B,[@Mehra2022] will lead to &uarr;NE, &uarr;NPY, &uarr;Gal expression.
