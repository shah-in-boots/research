...
The focus of the proposal is on phenotyping of paroxysmal AF alone, however additional data will likely be generated to support the K23 additional aims. 
The K23 aims are loosely the following:

1. Identify phenotypes of paroxysmal AF that are predominantly trigger-driven versus scar-mediated
1. Determine the autonomic signature and electrophysiological properties of autonomically-mediated paroxysmal AF
1. Evaluate the increased risk of paroxysmal AF due to common and rare genetic variants in cardiovagal receptors in cases of autonomically-mediated paroxysmal AF

This proposal aims to identify clinical phenotypes of **paroxysmal AF** that have a higher or increased risk of progression to a more *persistent* or *treatment-resistant* class based on burden of disease, electrical and structural remodeling, and the development of both atrial and ventricular cardiomyopathy. 

[Question]{.underline}: Can we identify which patients will progress more rapidly to persistent AF, or develop complications of AF? Are there electrocardiographic or clinical parameters that predict electrical and structural remodeling?

[Hypothesis]{.underline}: The longitudinal trajectory of pAF can be predicted by subphenotypes of paroxysmal AF based on electrical, clinical, and structural cardiac properties. 
...
1. Generation of clinical features are both cross-sectional and longitudinal, and will be generated from both structured and unstructured text, as in @fig-patient-timeline
...
1. After general clusters are determined, can assess trajectory of AF. The trajectories can then *feedback* to generate phenotypical categories. Deep-learning approach will be used to identifying features associated with higher-risk phenotypes of paroxysmal AF, similar to @fig-ecg-dz.
...
![After creating median beats, components of the ECG can be compared between disease and non-disease states. This can be used to help classify risk for disease based on ECG-based features as seen by @vandeLeur2021](../figures/van-de-Leur-2021-ecg-disease-specific-ml.png){#fig-ecg-dz}
