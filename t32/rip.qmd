...
#| echo: false
dt <- 
	date_build(year = 2023, month = 6, day = 5) |>
	add_days(-30)
...
## Aims Updates {.smaller}

1. Pending mentorship meeting (dates requested for Alvaro, Amit, Dawood)
1. Met with Lampert - be much more specific in ANS factors in pAF
