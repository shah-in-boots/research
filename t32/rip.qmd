...
#| echo: false
dt <- 
	date_build(year = 2023, month = 3, day = 13) |>
	add_days(-14)
...
- AFL/FH: manuscript was sent for initial revisions (03/03/23), __pending feedback__
...
- [HRV/CVD]{.blue} : priority for this week, with HF/LF HRV values showing >10 fold HR for bottom versus top quartile (with almost >95% sensitivity)
- VCF analysis: ACER will share AWS for us + a few thousand compute hours for start up to help estimate costs
