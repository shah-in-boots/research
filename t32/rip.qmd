...
#| echo: false
dt <- 
	date_build(year = 2023, month = 11, day = 20) |>
	add_days(-30)
...
- [ ] If feedback not received by Thanksgiving, should we request extension?

## AF Registry and CCTS Data

1. Have all EMR data from 2010 to 2023 now, which increased file sizes by 30% (now over 70 Gb)
...
Which key variables should be included for evaluation?
