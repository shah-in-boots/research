...
affiliations:
  - id: utah
    ...
    state: UT
  - id: gewva
    name: George E. Wahlen Veterans Affairs Medical Center
    city: Salt Lake City
    state: UT
...
As a reference, a nation-wide study by @Kirkfeldt2014 showed that over 1 year, had 562 complications out of 5918 implants. 
...
#| echo: false
#| warning: false
#| fig-cap: "Breakdown of Procedural Complications Reported from the MAUDE Database. The figure breaks down the frequency and summary of key complication reports seen in the MAUDE database for the EV-ICD generator and lead. The figure demonstrates the relative frequency of events. The specific events are displayed alphabetically."
#| fig-height: 10
#| fig-width: 10
